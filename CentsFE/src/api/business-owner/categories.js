...
export const createOrUpdateSubcategory = (data) => {
  return httpClient({
    method: "POST",
    url: "/business-owner/admin/services/cat/save",
    data,
  });
};
...
export const createOrUpdateTurnaroundTime = ({
  serviceCategoryTypeId,
  turnAroundInHours,
}) => {
  const data = {serviceCategoryTypeId, turnAroundInHours};
  return httpClient({
    method: "PUT",
    url: "business-owner/admin/services/categories/turn-around-time",
    data,
  });
};
