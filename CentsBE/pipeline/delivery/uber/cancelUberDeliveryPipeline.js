...
const cancelUberDelivery = require('../../../uow/delivery/cancel/cancelUberDeliveryUow');
 ...
 */
async function cancelUberDeliveryPipeline(payload) {
    try {
...
module.exports = exports = cancelUberDeliveryPipeline;
