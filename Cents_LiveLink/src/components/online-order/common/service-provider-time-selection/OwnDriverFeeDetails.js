...
const OwnDriverFeeDetails = props => {
  const {isPickup, settings} = props;

  const deliveryFee = Math.ceil(settings.deliveryFeeInCents / 2);
    ...
    <Flex {...styles.wrapper}>
      <Box>
        ...
        <Text {...styles.deliveryFee}>
          ...
          {deliveryFee ? toDollars(deliveryFee / 100) : "Free"}
        </Text>
      </Box>
      <Image
